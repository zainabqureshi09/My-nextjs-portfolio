  ...
  return (
    <div className="w-full sm:w-auto">
      <motion.div
        ...
        ref={ref}
      >
        <section className="rounded-lg relative bg-gradient-to-r from-purple-200 to-pink-300 max-w-[32rem] p-5 text-left border border-pink-100 overflow-hidden sm:h-[20rem] group-even:pl-5 hover:from-blue-300 hover:to-pink-300 transition flex flex-col sm:flex-row">
          ...
          <div className="p-4 sm:p-6 sm:w-1/2">
            ...
            <p className="mt-2 leading-relaxed text-lg font-bold text-pink-800">{description}</p>
