...
import profileImg5 from "@/public/zainab.png";
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              height={400}
              priority
              className="h-24 w-24 rounded-full border-[0.35rem] border-blue-100 object-cover shadow-xl hover:scale-150 transition"
            />
          </motion.div>
